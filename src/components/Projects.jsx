...
const projects = [
  ...
  },
  {
    ...
    solution: "Converts long-form content into posts, captions, and summaries automatically.",
    ...
    <section id="projects" className="py-20 md:py-24 px-4 sm:px-6 relative">
      ...
      <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
        {projects.map((p, i) => (
          <motion.div
            key={i}
            className="flip-wrap h-72 sm:h-80"
            ...
            <div className="flip-inner">
              ...
              <div className="flip-front glass glow-card card overflow-hidden">
                ...
                <div className="relative z-10 p-5 sm:p-6 h-full flex flex-col">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-3 leading-snug">{p.title}</h3>
                  <div className="h-px bg-gradient-to-r from-white/0 via-white/10 to-white/0 mb-3" />
                  <p className="text-[9px] uppercase tracking-[0.2em] text-purple-400/50 mb-2">The Problem</p>
                  <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">{p.problem}</p>
                  <p className="mt-auto text-[10px] text-white/20 flex items-center gap-1.5">
              ...
              >
                ...
                <div className="relative z-10 p-5 sm:p-6 h-full flex flex-col">
                  <p className="text-[9px] uppercase tracking-[0.2em] text-purple-400/50 mb-1">Solution</p>
                  <p className="text-gray-300 text-xs leading-relaxed mb-3">{p.solution}</p>
 
                  <p className="text-[9px] uppercase tracking-[0.2em] text-purple-400/50 mb-2">Tech</p>
                  ...
                  <div className="flex items-start gap-2 rounded-xl border border-green-500/20 bg-green-500/5 px-3 py-2 mb-4">
                    <span className="text-green-400 text-xs shrink-0 mt-0.5">↑</span>
                    <p className="text-green-400 text-xs leading-relaxed">{p.result}</p>
                  </div>
                  ...
                  <div className="flex gap-2 mt-auto">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 text-center px-3 py-2 rounded-xl bg-white/10 border border-white/20 hover:bg-purple-500/30 hover:border-purple-500/50 transition-all duration-300 text-xs"
                    >
                      GitHub ↗
                    </a>
                    {p.demo !== "#" && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex-1 text-center px-3 py-2 rounded-xl bg-white/10 border border-white/20 hover:bg-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300 text-xs"
                      >
                        Live Demo ↗
                      </a>
                    )}
